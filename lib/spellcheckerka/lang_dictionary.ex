defmodule SpellCheckerKa.LangDictionary do
  @moduledoc """
  ...
  def remove_word(word, lang) when lang in @supported_langs do
    ...
    path = Application.app_dir(:spellcheckerka, "priv/static/dictionaris/user_words_#{lang}.txt")
  ...
  def init(_) do
    Enum.each(@supported_langs, fn lang ->
      ...
      path      = Application.app_dir(:spellcheckerka, "priv/static/dictionaris/#{lang}.txt")
      user_path = Application.app_dir(:spellcheckerka, "priv/static/dictionaris/user_words_#{lang}.txt")
      load_file(lang, path)
