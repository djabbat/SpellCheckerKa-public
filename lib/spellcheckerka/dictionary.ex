defmodule SpellCheckerKa.Dictionary do
  @moduledoc """
  ...
  alias SpellCheckerKa.Morphology
  ...
  def remove_word(word) do
    ...
    path = Application.app_dir(:spellcheckerka, @user_words_path)
  ...
  def init(_) do
    ...
    path       = Application.app_dir(:spellcheckerka, @dict_path)
    user_path  = Application.app_dir(:spellcheckerka, @user_words_path)
    load_file(path)
